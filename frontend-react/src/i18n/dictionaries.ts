...
const en = {
  ...
  nav: {
    workspace: "Desk",
    evidenceOs: "Evidence OS",
    aiStrategy: "AI research tool",
    aiStrategyTool: "AI research tool",
    paperTrading: "Paper Trading",
    factorScans: "Param scans",
    feed: "Feed",
    leaderboards: "Ranks",
  ...
  adminOps: {
    ...
    instVnpyOrders: "legacy vn.py (historical)",
  ...
  masteryPath: {
    ...
    shareReady: "Share stage — publish and grow your network",
    shareHint: "Publish to the feed, create a share card, then read peers on your following stream to complete the mastery loop.",
    shareReportCta: "Generate report →",
    sharePublishCta: "Publish to feed →",
    shareCardCta: "Create share card →",
    shareFollowingCta: "Open following feed →",
    shareNetworkCta: "Follow researchers →",
    shareReplicationCta: "Read masters →",
    shareQualityLocked: "Quality gate not passed yet — fix validation scores before publishing to the feed.",
  ...
  aiReview: {
    ...
    scanFailScoped: "AI review is temporarily unavailable. Scan results were generated normally.",
  },
  qualityCoach: {
  ...
  factorScan: {
    ...
    fail: "Scan could not finish. Please try again shortly.",
    auxPartialFail: "Scan results are ready. Some auxiliary info is temporarily unavailable.",
    apply: "Load factor",
  ...
  experiments: {
    title: "Param scans",
    subtitle: "Factor parameter scans — not the Experiment Ledger. Use Evidence OS for sealed experiments.",
  ...
  l4Tools: {
    ...
    sharpe: "Sharpe",
    drawdown: "Drawdown",
    execTitle: "Paper execution",
    execDesc: "Institutional paper order routing with regime risk gates. Legacy vn.py channel is retired (history only).",
    execDescLinked: "Factor linked from your project — submit a paper order to start real tracking.",
    execBuy: "Buy",
    execSell: "Sell",
    execChannelPaper: "Paper",
    execChannelVnpy: "Legacy vn.py (no new orders)",
...
const zh = {
  ...
  adminOps: {
    ...
    instVnpyOrders: "历史 vn.py 订单（仅审计）",
  ...
  masteryPath: {
    ...
    shareReady: "分享阶段 — 发布成果，扩大人脉",
    shareHint: "发布到广场、生成分享卡片，再去关注动态精读同伴报告，完成大师闭环。",
    shareReportCta: "生成报告 →",
    sharePublishCta: "发布到广场 →",
    shareCardCta: "生成分享卡片 →",
    shareFollowingCta: "打开关注动态 →",
    shareNetworkCta: "去关注研究员 →",
    shareReplicationCta: "读大师报告 →",
    shareQualityLocked: "质量门槛尚未通过 — 请先修复验证分数，再发布到广场。",
  ...
  aiReview: {
    ...
    fail: "AI 分析失败",
    scanFailScoped: "AI 解读暂时不可用，扫描结果已正常生成。",
  },
  qualityCoach: {
    title: "下一步怎么做",
    adjustFactor: "去改因子",
  ...
  landing: {
    ...
    masteryPathTitle: "通往证据系统之路",
    masteryPathDesc: "注册后在工作台跟着「先证明，再下注」走 — 证据判定先于模拟，模拟先于任何实盘申请。",
    masteryPathChain: "策略 → 实验 → 证据 → 晋级/暂缓/淘汰 → 正式模拟 → 影子对照 → 实盘资格",
    step1Title: "1. 选研究模板",
  ...
  factorScan: {
    ...
    fail: "扫描暂时未完成，请稍后重试。",
    auxPartialFail: "扫描结果已生成，部分辅助信息暂时不可用。",
    apply: "载入因子",
  ...
  experiments: {
    title: "参数扫描",
    subtitle: "因子参数扫描记录（不是实验账本）。封印实验请去「证据系统」。",
    emptyTitle: "还没有扫描记录",
  ...
  l4Tools: {
    ...
    drawdown: "回撤",
    execTitle: "纸面执行",
    execDesc: "机构级纸面下单，含制度×策略风控闸门。vn.py 通道已停止新增，仅保留历史记录。",
    execDescLinked: "已绑定本项目因子 — 提交 Paper 单即可开启真实跟踪。",
    execBuy: "买入",
    execSell: "卖出",
    execChannelPaper: "纸面模拟",
    execChannelVnpy: "历史引擎：vn.py（已停止新增）",
