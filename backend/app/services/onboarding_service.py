...
def first_validation_coaching_payload(
    ...
    *,
    ...
    labels = i18n.FIRST_VALIDATION_COACH.get(locale) or i18n.FIRST_VALIDATION_COACH["en"]
...
def _mastery_goal_payload(db: Session, user: User, locale: Locale) -> dict:
    ...
    challenge_paper = challenge_service.challenge_paper_milestones_for_journey(db, user, locale)
    challenge_share = challenge_service.challenge_share_milestones_for_journey(db, user, locale)
    ...
    return {
        ...
        "challenge_share_milestones": challenge_share,
...
def research_journey(
    ...
    first_validation_coaching = first_validation_coaching_payload(
        db,
        user,
        locale,
        flags,
