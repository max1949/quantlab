...
& $py -c "from backend.app.core.database import SessionLocal; from backend.app.services.market_data import seed_real_market_data; db=SessionLocal(); print('seed result:', seed_real_market_data(db)); db.close()"
